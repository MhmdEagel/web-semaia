...
export default function Footer() {
  return (
    <footer className="p-4 bg-accent sm:p-6">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <Link href="/" className="flex items-center">
                    <Image src="/images/Brand.svg" width={80} height={80} className="h-8" alt="FlowBite Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-foreground">Semaia</span>
                </Link>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-foreground uppercase ">Links</h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-foreground sm:text-center ">© 2025 Semaia. All Rights Reserved.
            </span>
